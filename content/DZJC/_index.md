...
<section class="dzjc-section" aria-labelledby="screenshots">
  ...
  <p>Live Google Scholar screenshots are not published here yet because Google Scholar returned unusual-traffic/CAPTCHA protection during the automated capture attempt. Fixture screenshots are kept out of the public gallery to avoid presenting simulated Scholar pages as live results.</p>
  <div class="dzjc-screenshot-grid">
    <figure class="dzjc-screenshot">
      <img src="/DZJC/assets/popup-search.png" alt="DZ Journal Check popup showing a Category A result for Physical Review B">
      <figcaption>Popup search by journal title, showing a Category A result for Physical Review B.</figcaption>
    </figure>
    <div class="dzjc-note">
      <h3>Chrome Web Store screenshots</h3>
      <p>The final Chrome Web Store gallery will be updated after live Google Scholar pages are accessible without CAPTCHA and the screenshots are visually approved.</p>
    </div>
  </div>
</section>
